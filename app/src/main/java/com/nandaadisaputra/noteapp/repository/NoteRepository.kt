...
import com.nandaadisaputra.noteapp.model.Note
import com.nandaadisaputra.noteapp.model.NoteResponse
import com.nandaadisaputra.noteapp.model.SingleNoteResponse
import com.nandaadisaputra.noteapp.network.NoteApi
...
class NoteRepository {
    ...
    fun addNote(t: String, d: String): NoteResponse? = try {
        ...
        Log.e("AddNote", e.message.toString())  // Menangani error jika gagal
        null  // Mengembalikan null jika terjadi error
    }
